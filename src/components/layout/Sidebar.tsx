      ...
      <div className="flex flex-col h-full">
        ...
        <nav className="flex-1 px-4 py-2 space-y-1 overflow-y-auto custom-scrollbar">
          <div className="pb-2">
            ...
            <Link href="/models" className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-300 ${pathname.startsWith("/models") ? "bg-primary/20 text-accent-gold border border-primary/30 shadow-lg shadow-primary/5" : "text-text-muted hover:bg-text-main/5 hover:text-text-main"}`}>
