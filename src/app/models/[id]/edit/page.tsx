      ...
      try {
        ...
        if (modelSnap.exists()) {
          ...
          setGeneralInfo(prev => ({
            ...
            // Los siguientes pueden ser sobreescritos por V2
        ...
        if (profileSnap.exists()) {
          ...
          // Si no hay V2, habilitamos API para las plataformas iniciales por defecto
    ...
    <div className="p-8 max-w-5xl mx-auto w-full animate-in fade-in duration-500">
      ...
      <div className="mb-10 lg:flex items-start justify-between gap-10">
        <div className="flex-1">
            <h3 className="font-display text-4xl font-black text-white">Editar Perfil V2</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                    ...
                    <input 
                        ...
                        placeholder="Ej: 22"
                        className="w-full bg-background-dark/50 border border-primary/10 rounded-xl px-4 py-3 text-sm text-white"
                    />
                </div>
                <div className="space-y-2">
                    ...
                    <select 
                        ...
                        className="w-full bg-background-dark/50 border border-primary/10 rounded-xl px-4 py-3 text-sm text-white outline-none"
                    >
